            ...
            >
              ...
              <div className="absolute -top-3 -right-3 w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-gold/20">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
                  <path d="M14.017 21L14.017 17C14.017 17 15.739 17 13.828V13.828C15.739 13.828 17 12.828C17 11.828 15.739 11.828 14.017 11.828C14.017 11.828 12.296 11.828 13.828 11.828C15.359 11.828 16.828 13.828 16.828 15.739 14.017 15.739C14.017 15.739 14.017 21Z" />
                </svg>
              </div>
