    ...
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-6 lg:px-10 xl:px-12">
        <div className="flex items-center justify-between h-16 sm:h-18 md:h-[72px] lg:h-20">
          ...
          >
            <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-9 md:h-9 lg:w-10 lg:h-10 bg-[hsl(221,54%,53%)] rounded-lg flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110">
              <span className="text-[hsl(0,0%,100%)] font-bold text-base sm:text-lg md:text-lg lg:text-xl">
                {siteConfig.brandMarkText}
              </span>
            </div>
            <span className="text-lg sm:text-xl md:text-xl lg:text-2xl font-bold text-foreground hover:text-[hsl(221,54%,53%)] transition-colors duration-300 whitespace-nowrap">
          ...
          <div className="hidden md:flex items-center space-x-1 lg:space-x-2 xl:space-x-4">
            {navItems.map((item) => (
              ...
              >
                {item.name}
                <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-[hsl(221,54%,53%)] group-hover:w-4/5 transition-all duration-300" />
              </button>
            ))}
          </div>
          ...
          <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
            ...
            <Link
              ...
              className="text-sm px-3 lg:px-4 py-2 border border-[hsl(221,54%,53%)]/50 rounded-full hover:bg-[hsl(221,54%,53%)]/10 hover:border-[hsl(221,54%,53%)] transition-all duration-300 font-semibold whitespace-nowrap text-foreground"
            >
            ...
            <Link
              ...
              className="text-sm px-3 lg:px-4 py-2 bg-[hsl(221,54%,53%)] text-[hsl(0,0%,100%)] rounded-full hover:bg-[hsl(221,54%,45%)] transition-all duration-300 shadow-lg shadow-[hsl(221,54%,53%)]/30 font-semibold whitespace-nowrap"
            >
