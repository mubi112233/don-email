...
export const Footer: React.FC = () => {
  ...
  const links = {
    en: {
      ...
      serviceLinks: [
        { label: "Inbox Management", href: "/en/#services" },
        { label: "Email Automation", href: "/en/#services" },
      ...
      tagline: "Professional email management services. Transform inbox chaos into organized productivity. Save 15+ hours per week with expert email handling.",
    ...
    ge: {
      ...
      serviceLinks: [
        { label: "Inbox-Verwaltung", href: "/de/#services" },
        { label: "E-Mail-Automatisierung", href: "/de/#services" },
        { label: "Kampagnen-Management", href: "/de/#services" },
        { label: "Antwort-Management", href: "/de/#services" },
      ...
      tagline: "Professionelle E-Mail-Management-Dienstleistungen. Verwandeln Sie Inbox-Chaos in organisierte Produktivität. Sparen Sie 15+ Stunden pro Woche.",
    ...
    <footer className="w-full bg-[hsl(250,50%,12%)] border-t border-white/10 mt-8">
      <div className={`container mx-auto ${SPACING.container} py-12 sm:py-16`}>
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} don-email. {c.rights}</p>
